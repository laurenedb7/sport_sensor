	...
	<div class = "cat">
		...
		<table  width="90%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
			...
			while ($donnees = $req->fetch()){
				?>
				<tr class = "liensujet">
					<td align="center" class = "textsujet" class = "mess"><a href="forum_view_topic.php?id=<?php echo htmlspecialchars($donnees['idSujet']); ?>"><?php echo htmlspecialchars($donnees['titreSujet']); ?></a></td>
