...
<body>
	...
	?>
		...
		?>
	<div class = "cat">
		<a href="forum_categories.php"><strong>Choisir une autre catégorie / </strong> </a>
		<a href="forum_page.php?id_categorie=<?php echo htmlspecialchars($donnees['id_categorie']); ?>&nom_categorie=<?php echo htmlspecialchars($donnees['nomCategorie']); ?>"><strong>Choisir un autre sujet</strong> </a> <br><br>
		<div align = center class = tab>
			...
			<table cellpadding="10" cellspacing="0" class = rep >
				<tr bgcolor="#7ed957">
					<td width="10%" align="center" > <img width = "90%" src="forum_img.php?id=<?php echo htmlspecialchars($donnees['id_user']); ?>" alt="Photo de profil" /></td>
			...
			while($donnees2 = $req2->fetch()){
				...
				<table cellpadding="10" cellspacing="0" class = rep2>
					<tr bgcolor="#7ed957">
						<td width="10%" align="center" > <img width = "90%" src="forum_img.php?id=<?php echo htmlspecialchars($donnees2['id_user']); ?>" alt="Photo de profil" /></td>
